/* empty css                                 */
import { f as createAstro, g as createComponent, h as addAttribute, i as renderScript, j as renderTemplate, k as renderComponent, m as maybeRenderHead, s as spreadAttributes, F as Fragment, u as unescapeHTML, l as renderHead } from '../chunks/astro/server_JYZVRkO-.mjs';
import 'kleur/colors';
import 'clsx';
import { getIconData, iconToSVG } from '@iconify/utils';
import { $ as $$Image } from '../chunks/_astro_assets_BrR7TCOV.mjs';
export { renderers } from '../renderers.mjs';

const SITE_TITLE = "TechTots";
const SITE_DESCRIPTION = "Welcome to TechTots! We help kids aged 3-10 learn to code.";

const $$Astro$3 = createAstro("https://techtots-five.vercel.app/");
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$ClientRouter;
  const { fallback = "animate" } = Astro2.props;
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/home/super/Documents/techtots/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/super/Documents/techtots/node_modules/astro/components/ClientRouter.astro", void 0);

const $$Astro$2 = createAstro("https://techtots-five.vercel.app/");
...
}, "/home/super/Documents/techtots/src/components/BaseHead.astro", void 0);

const $$Astro$1 = createAstro("https://techtots-five.vercel.app/");
...
}, "/home/super/Documents/techtots/src/components/HeaderLink.astro", void 0);
...
}, "/home/super/Documents/techtots/node_modules/astro-icon/components/Icon.astro", void 0);
...
&copy; ${today.getFullYear()} All rights reverved.
<div class="flex items-center gap-6 text-5xl"> <a href="
      target=" _blank" class="py-1 pl-3 rounded-md border-1 border-black bg-ppink shadow-card hover:shadow-hover transition"> ${renderComponent($$result, "Icon", $$Icon, { "name": "1" })} </a> <a href="#" target="_blank" class="border-1 p-1 border-black rounded-full bg-pblue shadow-card hover:shadow-hover transition"> ${renderComponent($$result, "Icon", $$Icon, { "name": "2" })} </a> <a href="#" target="_blank" class="border-1 p-1 border-black rounded-full bg-pgreen shadow-card hover:shadow-hover transition"> ${renderComponent($$result, "Icon", $$Icon, { "name": "3" })} </a> </div> </footer>`;
}, "/home/super/Documents/techtots/src/components/Footer.astro", void 0);

const $$Hero = createComponent(($$result, $$props, $$slots) => {
  const images = /* #__PURE__ */ Object.assign({"/src/assets/euro.jpg": () => import('../chunks/euro_swc93Kx8.mjs'),"/src/assets/hero.png": () => import('../chunks/hero_D_6rW7_v.mjs')

});
  return renderTemplate`${maybeRenderHead()}<section class="py-20 flex md:flex-row flex-col px-4 md:px-0 gap-10 md:gap-0"> <div class="flex flex-col gap-6 justify-start items-start md:w-1/2"> <h1 class="text-pblack">Welcome</h1> <p class="text-6xl font-bold">Big ideas start with tiny coders.</p> <p>
We help kids aged 3-10 learn coding through play, creativity, and games—using tools like Scratch, stories, and imagination. 1-hour classes 3 times per week via Zoom!
</p> <a rel="noopener noreferrer" href="#" target="_blank" class="bg-pgreen px-5 py-3 border-1 border-black rounded-lg shadow-card hover:shadow-hover transition">
Subscribe for £20 per month
</a> <small>Cancel anytime.</small> </div> <div class="md:w-1/2 object-contain flex items-center justify-center p-10 group"> <div class="bg-pblue border-3 border-black rounded-2xl h-52 w-60 shadow-card group-hover:shadow-hover flex transition relative"> <div class="absolute -top-8 -left-12 text-5xl bg-ppink px-5 py-1 z-10 shadow-card group-hover:shadow-hover transition rounded-t-2xl border-3 border-black rounded-bl-2xl rounded-br-sm"> ${renderComponent($$result, "Icon", $$Icon, { "name": "paint" })} </div> <div class="absolute top-16 -right-16 text-5xl bg-pyellow p-2 z-10 shadow-card group-hover:shadow-hover transition rounded-full border-3 border-black"> ${renderComponent($$result, "Icon", $$Icon, { "name": "beach" })} </div> <div class="absolute text-nowrap flex items-center gap-4 -bottom-12 right-0 pr-4 bg-pgreen pl-1 z-10 shadow-card1 group-hover:shadow-card transition rounded-full border-3 border-black"> ${renderComponent($$result, "Icon", $$Icon, { "name": "beach" })} <p>We love Code.</p> </div> <div class="h-100 w-80 overflow-hidden relative -mt-30 rounded-2xl"> ${renderComponent($$result, "Image", $$Image, { "class": "object-bottom absolute bottom-0 group-hover:scale-105 transition", "src": images["/src/assets/hero.png"](), "alt": "Tech Tots Image" })} </div> </div> </div> </section>`;
}, "/home/super/Documents/techtots/src/components/Hero.astro", void 0);

const $$Video = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="flex flex-col text-center gap-4 "> <p class="text-pblack">Play is powerful.</p> <h2 class="text-4xl font-bold">Learning to code is fun.</h2> <h1>Video Here</h1> </section>`;
}, "/home/super/Documents/techtots/src/components/Video.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="en"> <head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": SITE_TITLE, "description": SITE_DESCRIPTION })}${renderHead()}</head> <body class="p-0 m-0 max-w-screen"> ${renderComponent($$result, "Header", $$Header, {})} <main class="container mx-auto md:px-10"> ${renderComponent($$result, "Hero", $$Hero, {})} ${renderComponent($$result, "Video", $$Video, {})} </main> ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
}, "/home/super/Documents/techtots/src/pages/index.astro", void 0);

const $$file = "/home/super/Documents/techtots/src/pages/index.astro";
const $$url = "";
